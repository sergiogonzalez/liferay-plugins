...
public class MentionsMessageServiceImpl extends MBMessageLocalServiceWrapper {
	...
	public MBMessage addDiscussionMessage(
		...
		notifyMentionedUsers(message, serviceContext);
	...
	protected void notifyMentionedUsers(
...
//		String messageURL = getMessageURL(message, serviceContext);
		...
		subscriptionSender.setEntryTitle(messageBody);
