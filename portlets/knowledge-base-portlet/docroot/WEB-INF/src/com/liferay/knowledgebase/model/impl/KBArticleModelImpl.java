...
public class KBArticleModelImpl extends BaseModelImpl<KBArticle>
	...
	public static KBArticle toModel(KBArticleSoap soapModel) {
		...
		model.setSourceLocation(soapModel.getSourceLocation());
	...
	public Object clone() {
		...
		kbArticleImpl.setSourceLocation(getSourceLocation());
	...
	public CacheModel<KBArticle> toCacheModel() {
		...
		kbArticleCacheModel.sourceLocation = getSourceLocation();

		String sourceLocation = kbArticleCacheModel.sourceLocation;

		if ((sourceLocation != null) && (sourceLocation.length() == 0)) {
			kbArticleCacheModel.sourceLocation = null;
		}
