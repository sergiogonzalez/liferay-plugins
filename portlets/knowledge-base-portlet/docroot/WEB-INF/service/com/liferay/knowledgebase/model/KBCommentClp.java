...
public class KBCommentClp extends BaseModelImpl<KBComment> implements KBComment {
	...
	public void setUserOpinion(int userOpinion) {
		_userOpinion = userOpinion;

		if (_kbCommentRemoteModel != null) {
			try {
				Class<?> clazz = _kbCommentRemoteModel.getClass();

				Method method = clazz.getMethod("setUserOpinion", int.class);

				method.invoke(_kbCommentRemoteModel, userOpinion);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public Object clone() {
		...
		clone.setUserOpinion(getUserOpinion());
	...
	public String toString() {
		...
		sb.append(", status=");
		sb.append(getStatus());
		sb.append(", userOpinion=");
		sb.append(getUserOpinion());
		sb.append("}");
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>userOpinion</column-name><column-value><![CDATA[");
		sb.append(getUserOpinion());
		sb.append("]]></column-value></column>");
