...
String[] userTypes = (String[])expandoColumn.getDefaultValue();
%>
	...
	<c:when test="<%= liveGroup.isRoot() %>">
		<aui:select helpMessage="mandatory-user-security-level-help" label="mandatory-user-security-level" name="TypeSettingsProperties--mandatoryUserSecurityLevel--">
			...
			%>
				...
				<aui:option label="<%= userType %>" selected="<%= mandatoryUserSecurityLevel.equals(userType) %>" value="<%= userType %>" />
...
<aui:script>
	...
	function <portlet:namespace />openForbiddenSiteRoleSelector() {
		var url = '<portlet:renderURL windowState="<%= LiferayWindowState.POP_UP.toString() %>"><portlet:param name="struts_action" value="/sites_admin/select_site_role" /><portlet:param name="step" value="2" /><portlet:param name="target" value="selectForbiddenRole" /><portlet:param name="groupId" value="<%= String.valueOf(groupId) %>" /></portlet:renderURL>';
	...
	function <portlet:namespace />openMandatorySiteRoleSelector() {
		var url = '<portlet:renderURL windowState="<%= LiferayWindowState.POP_UP.toString() %>"><portlet:param name="struts_action" value="/sites_admin/select_site_role" /><portlet:param name="step" value="2" /><portlet:param name="target" value="selectMandatoryRole" /><portlet:param name="groupId" value="<%= String.valueOf(groupId) %>" /></portlet:renderURL>';
